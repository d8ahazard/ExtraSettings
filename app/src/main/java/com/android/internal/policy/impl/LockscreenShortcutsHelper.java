...
public class LockscreenShortcutsHelper {
    ...
    public LockscreenShortcutsHelper(Context context, OnChangeListener listener) {
        ...
        if (listener != null) {
            ...
            mContext.getContentResolver().registerContentObserver(
                    Settings.Secure.getUriFor("lockscreen_target_actions"), false, mObserver);
        }
        fetchTargets();
    }
    ...
    private void fetchTargets() {
        String baseString = Settings.Secure.getString(mContext.getContentResolver(), "lockscreen_target_actions");
    ...
    public void saveTargets(ArrayList<String> targets) {
        String store = TextUtils.join(DELIMITER, targets);
        Settings.Secure.putString(mContext.getContentResolver(), "lockscreen_target_actions", store);
    }
}
